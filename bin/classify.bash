...
$dependpath/Kraken2/kraken2 --threads 2 --db $kraken2db --output - --report ${pair_id}_kraken2.tab --paired ${pair_id}_trim_R1.fastq.gz  ${pair_id}_trim_R2.fastq.gz 

$dependpath/Bracken-2.6.0/bracken -d $kraken2db -r 150 -l S -t 10 -i ${pair_id}_kraken2.tab -o ${pair_id}_bracken.out
